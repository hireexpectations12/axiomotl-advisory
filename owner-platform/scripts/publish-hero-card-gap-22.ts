...
const css = await readFile(
  new URL("../design/combined/hero-card-gap-22.css", import.meta.url),
  "utf8",
);
if (home.css.includes("/* Exact 22px workflow-card gap: 4px card track + 18px scene padding. */"))
  throw new Error(
...
await writeFile(
  new URL(`hero-card-gap-22-${Date.now()}.json`, backupDir),
