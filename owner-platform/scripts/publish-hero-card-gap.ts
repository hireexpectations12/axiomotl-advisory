...
const css = await readFile(
  new URL("../design/combined/hero-card-gap.css", import.meta.url),
  "utf8",
);
if (home.css.includes("/* Small breathing room beneath the workflow cards. */"))
  throw new Error(
...
await writeFile(
  new URL(`hero-card-gap-${Date.now()}.json`, backupDir),
