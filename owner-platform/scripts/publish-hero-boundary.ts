...
const css = await readFile(
  new URL("../design/combined/hero-boundary.css", import.meta.url),
  "utf8",
);
if (home.css.includes("/* Compact hero boundary: remove the outer aspect-ratio spacer. */"))
  throw new Error(
...
await writeFile(
  new URL(`hero-boundary-${Date.now()}.json`, backupDir),
