...
const css = await readFile(
  new URL("../design/combined/hero-spacing.css", import.meta.url),
  "utf8",
);
if (home.css.includes("/* Tighten the transition from workflow cards to the next section. */"))
  throw new Error(
...
await writeFile(
  new URL(`hero-spacing-${Date.now()}.json`, backupDir),
