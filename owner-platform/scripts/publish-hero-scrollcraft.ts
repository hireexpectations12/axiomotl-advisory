...
const css = await readFile(
  new URL("../design/combined/hero-scrollcraft.css", import.meta.url),
  "utf8",
);
if (home.css.includes("/* Scroll Craft hero: independent depth without extra scroll space. */"))
  throw new Error(
...
await writeFile(
  new URL(`hero-scrollcraft-${Date.now()}.json`, backupDir),
