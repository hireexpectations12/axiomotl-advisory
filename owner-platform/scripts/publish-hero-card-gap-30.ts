...
const css = await readFile(
  new URL("../design/combined/hero-card-gap-30.css", import.meta.url),
  "utf8",
);
if (home.css.includes("/* Exact 30px workflow-card gap: 4px card track + 26px scene padding. */"))
  throw new Error(
...
await writeFile(
  new URL(`hero-card-gap-30-${Date.now()}.json`, backupDir),
